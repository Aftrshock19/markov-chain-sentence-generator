...
SPANISH_SPECIAL_VERBS = {
    "ser", "estar", "haber", "tener", "hacer", "decir", "ir", "ver", "dar", "saber",
    "conocer", "poder", "querer", "venir", "poner", "salir", "llegar", "sentir",
    "parecer", "creer",
}
...
def render_generic_verb(lemma: str, lemma_translation: str, tags: Sequence[str]) -> Tuple[str, str]:
    ...
    if bucket == "present_subj":
        forms = [base for base in bases[:3]]
        return "; ".join(f"{form} (subj.)" for form in forms), "low"
    if bucket == "imperative":
        forms = [base for base in bases[:3]]
        return "; ".join(f"{form}!" for form in forms), "low"
    return lemma_translation, "low"
...
def render_special_verb(lemma: str, tags: Sequence[str]) -> Optional[Tuple[str, str]]:
    ...
    if lemma in {"ser", "estar"}:
        ...
        if bucket in {"past", "imperfect"} and pronoun:
            ...
            return f"{pronoun} {forms[pronoun]}", "high"
        if bucket == "future" and pronoun:
            return f"{pronoun} will be", "high"
        if bucket == "conditional" and pronoun:
            return f"{pronoun} would be", "high"
        if bucket == "present_subj":
            return "be (subj.)", "medium"

    if lemma == "haber":
        if bucket == "inf":
            return "to have; there is; there are", "high"
        if bucket == "ger":
            return "having", "high"
        if bucket == "pp":
            return "had", "high"
        ...
        if bucket in {"past", "imperfect"} and pronoun:
            return f"{pronoun} had", "high"
        if bucket == "future" and pronoun:
            return f"{pronoun} will have", "high"
        if bucket == "conditional" and pronoun:
            return f"{pronoun} would have", "high"
        if bucket == "present_subj":
            return "have (subj.)", "medium"
    ...
    if lemma == "hacer":
        if bucket == "inf":
            return "to do; to make", "high"
        if bucket == "ger":
            return "doing; making", "high"
        if bucket == "pp":
            return "done; made", "high"
        if bucket == "present" and pronoun:
            if pronoun == "he/she/it":
                return "he/she/it does; he/she/it makes", "high"
            return f"{pronoun} do; {pronoun} make", "high"
        if bucket in {"past", "imperfect"} and pronoun:
            return f"{pronoun} did; {pronoun} made", "high"
        if bucket == "future" and pronoun:
            return f"{pronoun} will do; {pronoun} will make", "high"
        if bucket == "conditional" and pronoun:
            return f"{pronoun} would do; {pronoun} would make", "high"

    if lemma == "decir":
        if bucket == "inf":
            return "to say; to tell", "high"
        if bucket == "ger":
            return "saying; telling", "high"
        if bucket == "pp":
            return "said", "high"
        if bucket == "present" and pronoun:
            if pronoun == "he/she/it":
                return "he/she/it says; he/she/it tells", "high"
            return f"{pronoun} say; {pronoun} tell", "high"
        if bucket in {"past", "imperfect"} and pronoun:
            return f"{pronoun} said", "high"
        if bucket == "future" and pronoun:
            return f"{pronoun} will say; {pronoun} will tell", "high"
        if bucket == "conditional" and pronoun:
            return f"{pronoun} would say; {pronoun} would tell", "high"
    ...
    if lemma == "ir":
        ...
        if bucket == "present" and pronoun:
            if pronoun == "he/she/it":
                return "he/she/it goes", "high"
            if pronoun == "we":
                return "we go", "high"
            return f"{pronoun} go", "high"
        if bucket in {"past", "imperfect"} and pronoun:
            return f"{pronoun} went", "high"
        if bucket == "future" and pronoun:
            return f"{pronoun} will go", "high"
        if bucket == "conditional" and pronoun:
            return f"{pronoun} would go", "high"

    if lemma == "ver":
        if bucket == "present" and pronoun:
            return (f"{pronoun} sees" if pronoun == "he/she/it" else f"{pronoun} see"), "high"
        if bucket in {"past", "imperfect"} and pronoun:
            return f"{pronoun} saw", "high"
        if bucket == "inf":
            return "to see", "high"
        if bucket == "pp":
            return "seen", "high"
    ...
    if lemma == "dar":
        if bucket == "present" and pronoun:
            return (f"{pronoun} gives" if pronoun == "he/she/it" else f"{pronoun} give"), "high"
        if bucket in {"past", "imperfect"} and pronoun:
            return f"{pronoun} gave", "high"
        if bucket == "inf":
            return "to give", "high"
        if bucket == "pp":
            return "given", "high"
    ...
    if lemma in {"saber", "conocer"}:
        base = "know"
        if bucket == "present" and pronoun:
            return (f"{pronoun} knows" if pronoun == "he/she/it" else f"{pronoun} know"), "high"
        if bucket in {"past", "imperfect"} and pronoun:
            return f"{pronoun} knew", "high"
        if bucket == "inf":
            return "to know", "high"
        if bucket == "pp":
            return "known", "high"
    ...
    if lemma == "poder":
        if bucket == "inf":
            return "to be able to; can", "high"
        if bucket == "present" and pronoun:
            return f"{pronoun} can", "high"
        if bucket in {"past", "imperfect"} and pronoun:
            return f"{pronoun} could", "high"
        if bucket == "future" and pronoun:
            return f"{pronoun} will be able to", "high"
        if bucket == "conditional" and pronoun:
            return f"{pronoun} could; {pronoun} would be able to", "high"
        if bucket == "pp":
            return "been able to", "medium"
        if bucket == "ger":
            return "being able to", "medium"

    if lemma == "querer":
        if bucket == "inf":
            return "to want", "high"
        if bucket == "present" and pronoun:
            return (f"{pronoun} wants" if pronoun == "he/she/it" else f"{pronoun} want"), "high"
        if bucket in {"past", "imperfect"} and pronoun:
            return f"{pronoun} wanted", "high"
        if bucket == "future" and pronoun:
            return f"{pronoun} will want", "high"
        if bucket == "conditional" and pronoun:
            return f"{pronoun} would want", "high"

    if lemma == "venir":
        if bucket == "inf":
            return "to come", "high"
        if bucket == "present" and pronoun:
            return (f"{pronoun} comes" if pronoun == "he/she/it" else f"{pronoun} come"), "high"
        if bucket in {"past", "imperfect"} and pronoun:
            return f"{pronoun} came", "high"
        if bucket == "pp":
            return "come", "high"
        if bucket == "ger":
            return "coming", "high"
    ...
    if lemma == "poner":
        if bucket == "inf":
            return "to put", "high"
        if bucket == "present" and pronoun:
            return (f"{pronoun} puts" if pronoun == "he/she/it" else f"{pronoun} put"), "high"
        if bucket in {"past", "imperfect"} and pronoun:
            return f"{pronoun} put", "high"
        if bucket == "pp":
            return "put", "high"
        if bucket == "ger":
            return "putting", "high"
...
def render_surface_translation(
    surface: str,
    lemma: str,
    tags: Sequence[str],
    ...
    if pos == "noun" and "pl" in set(tags):
        ...
        if options:
            ...
            for opt in options[:3]:
                pluralized.append(pluralize_noun(opt))
...
def translate_csv(
    ...
    with open(out_main, "w", encoding="utf-8", newline="") as main_out, open(out_detail, "w", encoding="utf-8", newline="") as detail_out:
        ...
        for row in rows_cache:
            ...
            english_lemma, lemma_used, lemma_ok, lemma_source = translate_lemma(
                lemma_normalized,
                dictionary,
                accent_dictionary,
            )

            english_surface, surface_source, surface_confidence = render_surface_translation(
                surface_normalized,
                lemma_normalized,
                tags,
                english_lemma,
    ...
    with open(out_untranslated, "w", encoding="utf-8", newline="") as outfile:
        fieldnames_out = list(untranslated_rows[0].keys()) if untranslated_rows else [source_column or "lemma", "english_surface"]
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Translate Spanish tokens into English lemma glosses and flashcard-safe surface glosses using Apertium."
    )
